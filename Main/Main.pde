...
//widgets and buttons
Widget chartScreenButton,chartScreenButton_2,mapScreenButton, homeScreenButton,homeScreenButton_2,heatMapButton, heatMapButton_2,arrivalsButton_2,
heatMapButton_3, flightsButton, departuresButton, arrivalsButton, airlinesChartsScreenButton, pathSelectionScreenButton, pathsScreenButton, pathGenerateButton;
...
void setup(){
  ...
  airlineListForPaths = new ArrayList <String>();
   ...
   homeScreenButton = new Widget(365, 600, 155, 50, "Home Screen", widgetFont, EVENT_TO_HOME);
   chartScreenButton_2 = new Widget(575, 600, 125, 50, "Charts", widgetFont, EVENT_TO_CHARTS);
   arrivalsButton = new Widget(1000,200, 155,50, "Arrivals" , widgetFont, ARRIVALS);
  ...
  arrivalsButton_2 = new Widget(1000, 400, 155, 50, "Arrivals", widgetFont, ARRIVALS);
   ...
   heatMapButton_2 = new Widget(1000, 50, 135, 50, "HeatMap", widgetFont, EVENT_TO_HEATMAPS);
      
   heatMapButton_3 = new Widget(1000,200, 135, 50, "HeatMap", widgetFont, EVENT_TO_HEATMAPS);
     
     
     
  //pathScreen to mapped flight
  pathGenerateButton = new Widget (880, 300, 150, 50, "Generate", widgetFont, EVENT_GENERATE_PATH);
...
final PShape USA = loadShape("Usa7.svg");
  ...
  arrivals.setColourPalette(#FFFFCC, #A1DAB4, #41B6C4, #2C7FB8, #253494,#141e5e);
...
void mousePressed()
{
  ...
  //deletes generate path button after its been used, so that it can be re-added to path select screen later
